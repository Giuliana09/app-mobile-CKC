  ...
  return (
    <VStack style={styles.view}>
      ...
      <Box style={styles.onecard}>
        <TouchableOpacity onPress={() => navegarParaTelaSemParametros(navigation, 'SortearStack', 'SortearScreen1')}>
      ...
      <Box style={styles.card}>
        <TouchableOpacity onPress={() => navegarParaTelaSemParametros(navigation, 'CheckInStack', 'CheckinScreen1')}>
      ...
      {/* Card de check-out */}
      <Box style={styles.card}>
        <TouchableOpacity onPress={() => navegarParaTelaSemParametros(navigation, 'CheckOutStack', 'CheckOutScreen1')}>
